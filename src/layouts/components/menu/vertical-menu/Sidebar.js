                  ...
                  <Hammer
                    ...
                    <ul className="navigation navigation-main">
                      {currentUser && currentUser.userDetails &&
                                            ...
                                            currentUser={(currentUser && currentUser.userDetails && currentUser.userDetails[0].user_role) ? currentUser.userDetails[0].user_role: ""}
...
export default connect(mapStateToProps, {userDetailsFetch})(Sidebar)
