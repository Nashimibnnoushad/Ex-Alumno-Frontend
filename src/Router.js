...
const AlumniDashboard = lazy(() => import("./views/dashboard/alumni/alumnidashboard"))
...
class AppRouter extends React.Component {
  render() {
    return (
      ...
      {/* Alumni */}
      <AppRoute exact path="/" component={(props) => (localStorage.alumnitoken ? (<Redirect to="/dashboard" />) : (<Login {...props} />))} fullLayout  />
      <AppRoute exact path='/dashboard' component={(props) => (!localStorage.alumnitoken ? (<Redirect to="/" />) : (<AlumniDashboard {...props} />))} />
      <AppRoute path="/chat" component={(props) => (!localStorage.alumnitoken ? (<Redirect to="/" />) : (<Chat {...props} />))}  />
      <AppRoute
